...
if __name__ == '__main__':
    ...
    # 获取交易产品基础信息
    # result = accountAPI.get_account_instruments(instType = 'SPOT', uly = '', instFamily = '', instId = '')
    # print(result)
    ...
    # result = marketAPI.get_ticker('SOL-USDT')
    # print(result)
    # 获取指数行情  Get Index Tickers
    # result = marketAPI.get_index_ticker('SOL', 'SOL-USD')
    # print(result)
    # # 获取产品深度  Get Order Book
    # result = marketAPI.get_orderbook('SOL-USDT', '10')

    # # 获取产品轻量深度（该接口已下线）
    # result = marketAPI.get_books_lite(instId = 'SOL-USDT')


    # # 获取产品完整深度 GET /api/v5/market/books-full
    result = marketAPI.books_full('SOL-USDT', '1')
    print(result)
